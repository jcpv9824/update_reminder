...
| `c3.b.permisosAdmin` | B | **Ejecutar los scripts de permisos generados** (`asignar_permisos_admins_{COMPAÑÍA}.sql`) en la BD de cada compañía (CONF/USU/USU2, idempotente; requiere scripts 1–2). Si "no se encontró el usuario": el correo no coincide con Clásico → volver a la plantilla (RN-22) | ✔ | support | docx C3 Paso 8 (2026-07-10) |
