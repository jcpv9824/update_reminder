...
Aplicación web para gestionar las actualizaciones programadas de los clientes del ERP, sus dominios y bases de datos. Usa Azure Static Web Apps, Azure Functions, SQL Server, almacenamiento privado seleccionable entre Azure Blob y el gateway S3 de SeaweedFS, y Key Vault. Toda la interfaz está en español.
