...
|---|---|---|---|
| BR-AUTH-01 | El login usa correo y contrasena; no se usan roles seleccionables ni login Microsoft en la pantalla actual. | `frontend/src/tests/LoginPage.test.tsx` -> "muestra solo campos de correo y contraseña", "no muestra botón de Microsoft", "no muestra checkboxes de roles", "invoca entrar con email y contraseña" | Cubierta por integracion UI |
